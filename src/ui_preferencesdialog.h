...
struct PreferencesDialog
{
    ...
    void setupUi(QDialog *implementation)
    {
        ...
        sslSettingsPageFormLayout->setWidget(2, QFormLayout::LabelRole, new QLabel(i18n("Client Authentication:"), sslSettingsPageScrollAreaWidgetContents));
        ...
        sslSettingsPageFormLayout->setWidget(2, QFormLayout::FieldRole, sslClientAuthenticationCheckBox);
        ...
        uiSettingsFormLayout->setWidget(9, QFormLayout::LabelRole, new QLabel(i18n("Native LF:"), uiSettingsPageScrollAreaWidgetContents));
        uiNativeLookCheckBox = new QCheckBox(i18n("Use native Look & Feel (requires restart)"), uiSettingsPageScrollAreaWidgetContents);
        uiSettingsFormLayout->setWidget(9, QFormLayout::FieldRole, uiNativeLookCheckBox);
        uiSettingsFormLayout->setWidget(10, QFormLayout::LabelRole, new QLabel(i18n("Show Log Tabs:"), uiSettingsPageScrollAreaWidgetContents));
        uiLogTabsCheckBox = new QCheckBox(i18n("Shows log tabs when starting"), uiSettingsPageScrollAreaWidgetContents);
        uiSettingsFormLayout->setWidget(10, QFormLayout::FieldRole, uiLogTabsCheckBox);
        uiSettingsFormLayout->setWidget(11, QFormLayout::LabelRole, new QLabel(i18n("Show Startup Page:"), uiSettingsPageScrollAreaWidgetContents));
        uiShowStartupPageCheckBox = new QCheckBox(i18n("Open startup web page when starting"), uiSettingsPageScrollAreaWidgetContents);
        uiSettingsFormLayout->setWidget(11, QFormLayout::FieldRole, uiShowStartupPageCheckBox);
        uiSettingsFormLayout->setWidget(12, QFormLayout::LabelRole, new QLabel(i18n("Disable Tooltips:"), uiSettingsPageScrollAreaWidgetContents));
        uiDisableTooltipsCheckBox = new QCheckBox(i18n("Disables all tooltips"), uiSettingsPageScrollAreaWidgetContents);
        uiSettingsFormLayout->setWidget(12, QFormLayout::FieldRole, uiDisableTooltipsCheckBox);
        uiSettingsFormLayout->setWidget(13, QFormLayout::LabelRole, new QLabel(i18n("Normalize line-break:"), uiSettingsPageScrollAreaWidgetContents));
        ...
        uiSettingsFormLayout->setWidget(13, QFormLayout::FieldRole, uiNormalizeLinebreakCheckBox);
        uiSettingsFormLayout->setWidget(14, QFormLayout::LabelRole, new QLabel(i18n("Garbage Collection Interval (s):"), uiSettingsPageScrollAreaWidgetContents));
        ...
        uiSettingsFormLayout->setWidget(14, QFormLayout::FieldRole, uiGargabeCollectionIntervalSpinBox);
        uiSettingsFormLayout->setWidget(15, QFormLayout::LabelRole, new QLabel(i18n("Size of Raw Response Message to Show:"), uiSettingsPageScrollAreaWidgetContents));
        ...
        uiSettingsFormLayout->setWidget(15, QFormLayout::FieldRole, uiRawResponseSizeSpinBox);
        uiSettingsFormLayout->setWidget(16, QFormLayout::LabelRole, new QLabel(i18n("Size of Raw Request Message to Show:"), uiSettingsPageScrollAreaWidgetContents));
        uiRawRequestSizeSpinBox = new QSpinBox(uiSettingsPageScrollAreaWidgetContents);
        uiRawRequestSizeSpinBox->setMaximum(2147483647);
        uiSettingsFormLayout->setWidget(16, QFormLayout::FieldRole, uiRawRequestSizeSpinBox);
        uiSettingsFormLayout->setWidget(17, QFormLayout::LabelRole, new QLabel(i18n("Wrap content in Raw Message Viewers:"), uiSettingsPageScrollAreaWidgetContents));
        uiWrapRawContentCheckBox = new QCheckBox(i18n("Wraps content in Raw Message Viewers"), uiSettingsPageScrollAreaWidgetContents);
        uiSettingsFormLayout->setWidget(17, QFormLayout::FieldRole, uiWrapRawContentCheckBox);
        uiSettingsFormLayout->setWidget(18, QFormLayout::LabelRole, new QLabel(i18n("Disable Usage Statistics:"), uiSettingsPageScrollAreaWidgetContents));
        uiDisableUsageStatisticsCheckBox = new QCheckBox(i18n("Do not send usage statistics"), uiSettingsPageScrollAreaWidgetContents);
        uiSettingsFormLayout->setWidget(18, QFormLayout::FieldRole, uiDisableUsageStatisticsCheckBox);
        ...
        editorSettingsFormLayout->setWidget(2, QFormLayout::LabelRole, new QLabel(i18n("Disable auto-resize:"), editorSettingsPageScrollAreaWidgetContents));
        ...
        editorSettingsFormLayout->setWidget(2, QFormLayout::FieldRole, editorAutoResizeCheckBox);
        editorSettingsFormLayout->setWidget(3, QFormLayout::LabelRole, new QLabel(i18n("Tabbed request view:"), editorSettingsPageScrollAreaWidgetContents));
        ...
        editorSettingsFormLayout->setWidget(3, QFormLayout::FieldRole, editorTabbedCheckBox);
        editorSettingsFormLayout->setWidget(4, QFormLayout::LabelRole, new QLabel(i18n("Validate Requests:"), editorSettingsPageScrollAreaWidgetContents));
        ...
        editorSettingsFormLayout->setWidget(4, QFormLayout::FieldRole, editorValidateRequestCheckBox);
        editorSettingsFormLayout->setWidget(5, QFormLayout::LabelRole, new QLabel(i18n("Abort on invalid:"), editorSettingsPageScrollAreaWidgetContents));
        editorAbortInvalidCheckBox = new QCheckBox(i18n("Abort invalid requests"), editorSettingsPageScrollAreaWidgetContents);
        editorSettingsFormLayout->setWidget(5, QFormLayout::FieldRole, editorAbortInvalidCheckBox);
        editorSettingsFormLayout->setWidget(6, QFormLayout::LabelRole, new QLabel(i18n("Validate Responses:"), editorSettingsPageScrollAreaWidgetContents));
        ...
        editorSettingsFormLayout->setWidget(6, QFormLayout::FieldRole, editorValidateResponseCheckBox);
        ...
        globalPropertiesUpButton->setToolTip(i18n("Moves the selected property up one item"));
        ...
        globalSensitiveInformationTokensUpButton->setToolTip(i18n("Moves the selected property up one item"));
